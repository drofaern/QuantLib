...
#undef REPORT
#define REPORT(greekName, payoff, exercise, barrierType, barrier, s, q,\
                        r, today, v, expected, calculated, error, tolerance) \
    std::cout << payoff->optionType() << " option with " \
    ...
    try {
        BinaryOptionData values[] = {
            ...
            */
            ...
            { Barrier::UpIn,   103.00, 2.00, Option::Call,   0.00, 100.00, 0.00, 0.025, 2, 0.10,  0.0000, 1e-4 }
        ...
        for (auto& value : values) {
            ...
            REPORT("value", payoff, amExercise, value.barrierType, value.barrier, value.s,
